...
export class PublicacionesInventory
{
    ...
    listarServicio(): void {
        this._httpClient.get<InventarioPublicaciones[]>(environment.baseUrlm+"/api/publicaciones/listar")
          .subscribe((data) => {
      ...
      obtenerListaPublicaciones(): Observable<InventarioPublicaciones[]> {
        return this._httpClient.get<InventarioPublicaciones[]>(environment.baseUrlm+"/api/publicaciones/listar")
          .pipe(
