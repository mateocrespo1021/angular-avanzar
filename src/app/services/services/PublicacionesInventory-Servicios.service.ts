...
export class PublicacionesInventoryServicios
{
    ...
    listarServicio(): void {
        this._httpClient.get<InventarioPublicaciones[]>(environment.baseUrlm+"/api/publicaciones/listarServicio")
          .subscribe((data) => {
      ...
      obtenerListaPublicacionesXServicio(): Observable<InventarioPublicaciones[]> {
        return this._httpClient.get<InventarioPublicaciones[]>(environment.baseUrlm+"/api/publicaciones/listarServicio")
          .pipe(
